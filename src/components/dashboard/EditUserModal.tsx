      ...
      <div className="bg-white rounded-2xl max-w-lg w-full shadow-xl border border-slate-200 overflow-hidden">
        ...
        <form onSubmit={handleSave} className="p-6 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">
                Department * {currentUser?.role === 'ADMIN' && <span className="text-[10px] text-amber-700 font-normal lowercase">(locked)</span>}
              </label>
              <div className="relative">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1">
                Role / Access * {currentUser?.role === 'ADMIN' && <span className="text-[10px] text-amber-700 font-normal lowercase">(restricted)</span>}
              </label>
              <select
                value={role}
