...
const AppContent: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (theme) {
      ...
      root.style.setProperty('--nav-shadow', shadowMap[theme.navShadow || 'none'] || 'none');
      root.style.setProperty('--sidebar-shadow', shadowMap[theme.sidebarShadow || 'none'] || 'none');
      root.style.setProperty('--card-shadow', shadowMap[theme.cardShadow || 'sm'] || '0 1px 2px 0 rgb(0 0 0 / 0.05)');
    }
